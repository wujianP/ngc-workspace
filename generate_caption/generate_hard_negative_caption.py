"""
This is a script that used to generate hard negative captions
"""
...
from dataset import SMiTCaptionDataset
...
def main(args):
    ...
    # load data
    caption_dataset = SMiTCaptionDataset(caption_path=args.data_path,
    ...
    for cur_iter, (file_paths, prompts, captions, class_names, file_names) in enumerate(caption_dataloader):
        ...
        #         writer.writerow((file_path, class_name, output))
